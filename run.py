...
async def DrPepper(ctx):
    ...
    links = ["http://www.meatland.net/sites/default/files/can_pepper300x200.gif"]
    await client.send_message(ctx.message.channel, random.choice(links))

@client.command(pass_context=True)
async def MobyHuge(ctx):
    """You Know What This Is"""
    links = ["https://i.ebayimg.com/images/g/uRAAAOSwnONZBmo9/s-l500.jpg"]
    await client.send_message(ctx.message.channel, random.choice(links))
